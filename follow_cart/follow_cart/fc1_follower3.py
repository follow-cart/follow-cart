...
class FC1Follower3(Node):
    def __init__(self):
        super().__init__('fc1_follower3')
...
def main(args=None):
    ...
    fc1_follower3 = FC1Follower3()

    try:
        rclpy.spin(fc1_follower3)
    except KeyboardInterrupt:
        pass

    fc1_follower3.destroy_node()
    rclpy.shutdown()
