...
def generate_launch_description():
    ...
    # convoy_urdf_path = os.path.join(fc_pkg_share, 'urdf', 'convoy', 'jetbot.urdf')
    fc_urdf_path = os.path.join(fc_pkg_share, 'urdf', 'follow_cart', 'turtlebot3_waffle_pi.urdf')

    # rviz 파일 경로
    rviz_config_file_path = os.path.join(pkg_share, 'rviz', 'fc1_mapper.rviz')
